# VPC module — network foundation for production infrastructure
#
# Creates a VPC with public/private subnet pairs across availability zones,
# NAT gateway for private subnet egress, and consistent tagging.
# Used as the foundation for all compute and data tier modules.
